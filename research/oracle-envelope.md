...
All 548 records were minted in one run on `studio-host.local`, Apple M1 Ultra,
...
```sh
python3 research/mint_oracles.py --host studio-host --targets h13 h14 --case 'env_*' --force
```
...
# one family
python3 research/mint_oracles.py --host studio-host --targets h13 --case 'env_mm_*'
