...
This report records source-native compiler research at repository commit `d140e0026bc8641b96c9f5580e923c00637c4fd1`. The oracle ran on `studio-host.local`, Apple M1 Ultra, macOS 26.6.2 arm64. The oracle executable was `/tmp/h13-oracle/bin/ane-compile-hwx`, SHA-256 `b1bab437e2da0d26e65799698b63d8ad592d5455eec5da64c5877799b08abcbe`.
...
`python3 research/mint_oracles.py --host studio-host --targets h13 h14 --force`
