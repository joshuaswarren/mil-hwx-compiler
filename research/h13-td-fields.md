...
`studio-host.local` (Apple M1 Ultra, macOS 26.6.2 arm64) with
...
minted on `studio-host.local` (Apple M1 Ultra, macOS 26.6.2 arm64) with Apple's
...
studio-host.local with Apple's own compiler and decoded it into
