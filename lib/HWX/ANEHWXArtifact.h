...
/// Operation names of the scheduled stages this program executes, in
/// dispatch order. Informational: the runtime never interprets it.
@property(nonatomic, readonly, copy) NSArray<NSString *> *operations;
